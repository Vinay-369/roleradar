...
class OpportunityRejectionReason(str, Enum):
    NON_INDIA_GEOGRAPHY = "NON_INDIA_GEOGRAPHY"
    CLOSED_REQUISITION = "CLOSED_REQUISITION"
    INSUFFICIENT_DESCRIPTION = "INSUFFICIENT_DESCRIPTION"
    INVALID_OR_MISSING_APPLY_URL = "INVALID_OR_MISSING_APPLY_URL"
    DUPLICATE_OPPORTUNITY = "DUPLICATE_OPPORTUNITY"
    BENCHMARK_NON_LIVE_CONTAMINATION = "BENCHMARK_NON_LIVE_CONTAMINATION"
    SUSPICIOUS_OR_UNTRUSTED_SOURCE = "SUSPICIOUS_OR_UNTRUSTED_SOURCE"
    ROLE_IRRELEVANT = "ROLE_IRRELEVANT"
